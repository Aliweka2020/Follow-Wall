...
void go_to_goal_ao()
{
  ...
  theta_error = theta_fw - prev_theta;
  ...
  //    }
  //      if ((dsr60 < 30) | (dsl60 < 30) | (dsf < 30) | (dsr < 30) | (dsl < 30))  // at obstacle
  //      {
  //        theta_switch = theta_g_o;
  //      }
  //      else if ((dsr60 < 15) | (dsl60 < 15) | (dsf < 15) | (dsr < 15) | (dsl < 15))  // un safe
  //      {
  //        theta_switch = theta_ao;
  //      }
  //      else if ((dsr60 > 30) | (dsl60 > 30) | (dsf > 30) | (dsr > 30) | (dsl > 30))  // obstacle clear
  //      {
...
void print_every_500()
{
  ...
  Serial.print("\t\ttheta_fw: ");
  Serial.print(theta_fw * 180 / 3.1416);
  Serial.println();
  //  Serial.print("theta_error: ");
  //  Serial.print(theta_error);
